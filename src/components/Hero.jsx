...
const Hero = () => {
  return (
    <>
      <section className="py-12 pb-20 xl:py-24 h-fit xl:pt-28 bg-hero bg-no-repeat bg-bottom bg-cover dark:bg-none">
            ...
            <div className="flex max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left">
              ...
              <div className="flex flex-col gap-y-3 md:flex-row gap-x-3 mx-auto xl:mx-0 mb-12">
                <Link href={"/contact"}>
                  ...
                  <Button variant="secondary" className="gap-x-3 ml-3 mt-4">
                    Download <Send size={18} />
                  </Button>
                </Link>
              </div>
              <Socials
